...
public abstract class BaseFragment<T extends BaseContract.Presenter> extends Fragment implements BaseContract.View {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        PresenterConfiguration configuration = getMultioskeletonApplication().getPresenterConfiguration();
    ...
    protected final MultioskeletonApplication getMultioskeletonApplication() {
        return (MultioskeletonApplication) getActivity().getApplication();
    }
}
